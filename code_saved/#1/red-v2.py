...
class LaserTracker(object):
    ...
    def __init__(self, cam_width=600, cam_height=600, hue_min=20, hue_max=160,
        ...
        * ``val_min``, ``val_max`` -- Min/Max allowed pixel values
        ...
        will be ignored.
        * ``display2_thresholds`` -- if True, additional windows will display
        ...
        self.display2_thresholds = display2_thresholds
    ...
    def display2(self, img, frame):
        """Display the combined image and (optionally) all other image channels
        NOTE: default color space in OpenCV is BGR.
        """
        # cv2.imshow('RGB_VideoFrame', frame)
        # cv2.imshow('LaserPointer', self.channels['laser'])
        if self.display2_thresholds:
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if c == 1:
                            ...
                            display(dist_m, angle_text, True, 2, 0, True, v)
