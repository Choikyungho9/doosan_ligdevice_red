                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if c == 1:
                            ...
                            holex_c = int((x00 + x01))
                            holey_c = int((y00 + y10))
                            cv2.circle(im0, (x00, y00), 4, (0, 255, 0), -1)  # 1-point
                            cv2.circle(im0, (x00, y10), 4, (0, 255, 0), -1)  # 2-point
                            # cv2.circle(im0, (x01, y00), 4, (0, 255, 0), -1)  #3-point
                            # cv2.circle(im0, (x01, y10), 4, (0, 255, 0), -1)  #4-point
                            ...
                            red_color = (0,0,255)
                            point = 30, 30 + (i * 40)
                            cv2.putText(im0, str(angle_between(A, B)), point, font, 1, red_color, 2, cv2.LINE_AA)
                            # draw contour between to point
                            cv2.line(im0, (ref_w, ref_h), (x_center, y_center), (255, 0, 0), 2)
                            print('')
                            print("angle", angle_between(A, B))  # A: reference point  , B: relative point
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='yolov5lig.pt', help='model.pt path(s)')
