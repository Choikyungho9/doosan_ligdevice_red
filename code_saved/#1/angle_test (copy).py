import argparse, time, math, cv2, torch
...
#---------monitor.py---------------
import pygame, sys, os, serial, select, sys, matplotlib
...
sys.stdout = open('0723_angletest2/movement_angle10.csv','w')
...
def display(dist_m, angle_m, center_flag, center_x, center_y, arrival_flag, speed):
    ...
    info11 = pygame.font.SysFont(None, 70)
    info12 = pygame.font.SysFont(None, 70)
    dist = str("dist = ") + str(dist_m) + str(" cm")
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if c == 1:
                            ...
                            approch_angle = math.degrees(math.acos(width/((1200/150)*height)))
                            #print("row:",approch_angle)
                            print("width:",width,"height:",height,"width/height:",float("{:.2f}".format((width/height))),"Angle:",approch_angle,"odometer:",v2)
...
#=====================================================================================================================
                            ...
                            # CHANGE FONT HERE
                            #cv2.putText(im0,angle_text,(ref_w-30,ref_h),cv2.FONT_HERSHEY_COMPLEX,3,(0, 128, 229), 2)
#=====================================================================================================================

                            #display(dist_m, angle_text, True, '_', '_', True, v2)
                            if 280<dist_m<=300: 
                                display(dist_m+30, approch_angle, True, '_', '_', True, v2)
                            elif 260<dist_m<=280:
                                display(dist_m+30, approch_angle, True, '_', '_', True, v2)
                            elif 260<dist_m<=280:
                                display(dist_m+30, approch_angle, True, '_', '_', True, v2)
