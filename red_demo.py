...
from utils.plots import colors, plot_one_box, plot_one_box_center, plot_one_box2
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                det[:, :6] = scale_coords(img.shape[2:], det[:, :6], im0.shape).round()
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if c == 2:
                            ...
                            distancei = (2 * 31.4 * 180) * 5 / (width + height)
                            dist_m = int(distancei * 10) / 10
                            plot_one_box2(xyxy, im0, label=f'{distancei:.1f}cm', color=colors(c, True), line_thickness=2)
                            #print(xyxy,'1')
                            #print(im0,'2')
                        ...
                        if c == 1:
                            ...
                            x01_h = int(x_top + width * 0.28)
                            y10_h = int(y_top + height * 0.5)
...
#                            avg_height2=int(avg_height[0])*2                                 # height average
                            ...
                            cal_angle=(260*height*2)/(130*(width+14))
                            cal_angle2=(260*height*2)/(130*(width-10))
                            cal_angle22=(260*height*2)/(130*(width-20))
                            cal_angle3=(260*height*2)/(130*(width+40))
                            cal_angle4=(260*height*2)/(130*(width-7))
                            cal_angle5=(260*height*2)/(130*(width+27))
                            cal_angle6=(260*height*2)/(130*(width-47))                            
                            #cal_angle2=((260*avg_height2-5)/(130*avg_width2*2)))
                            #cal_angle3=((260*avg_height2-5)/(130*avg_width2*2)))
                            #print(cal_angle)
                            #--- pallet range ---#
                            if width<=232:  
                                if cal_angle <= 1:
                                    approch_angle= math.degrees(math.acos(cal_angle))
                                    #time.sleep(0.5)
                                    print(approch_angle,'1',avg_width2,avg_height2,';',width,height)
                                else:
                                    approch_angle= math.degrees(math.acos(0.99999))
                                    #time.sleep(0.5)
                                    print(approch_angle,'1-1',avg_width2,avg_height2,';',width,height)
                            elif 250>width>232:
                                if cal_angle2 <= 1:
                                    approch_angle= math.degrees(math.acos(cal_angle2))
                                    #time.sleep(0.5)
                                    print(approch_angle,'2',avg_width2,avg_height2,';',width,height)
                                else:
                                    approch_angle= math.degrees(math.acos(0.99999))
                                    #time.sleep(0.5)
                                    print(approch_angle,'2-1',avg_width2,avg_height2,';',width,height)
                            elif 280>width>=250:
                                if cal_angle2 <= 1:
                                    approch_angle= math.degrees(math.acos(cal_angle22))
                                    #time.sleep(0.5)
                                    print(approch_angle,'2',avg_width2,avg_height2,';',width,height)
                                else:
                                    approch_angle= math.degrees(math.acos(0.99999))
                                ...
                                if cal_angle3 <= 1:
                                    approch_angle= math.degrees(math.acos(cal_angle3))
                                    #time.sleep(0.5)
                                    print(approch_angle,'3')#,avg_width2,avg_height2,';',width,height)
                                else:
                                    approch_angle3= math.degrees(math.acos(0.99999))
                                    #time.sleep(0.5)
                                    print(approch_angle,'3-1',avg_width2,avg_height2,';',width,height)
                            elif 400>width>=300:
                                if cal_angle4 <= 1:
                                    approch_angle= math.degrees(math.acos(cal_angle4))
                                    #time.sleep(0.5)
                                    print(approch_angle,'4')#,avg_width2,avg_height2,';',width,height)
                                else:
                                    approch_angle4= math.degrees(math.acos(0.99999))
                                    #time.sleep(0.5)
                                    print(approch_angle,'4-1',avg_width2,avg_height2,';',width,height)
                            elif 430>width>=400:
                                if cal_angle5 <= 1:
                                    approch_angle= math.degrees(math.acos(cal_angle5))
                                    #time.sleep(0.5)
                                    print(approch_angle,'5')#,avg_width2,avg_height2,';',width,height)
                                else:
                                    approch_angle= math.degrees(math.acos(0.99999))
                                    #time.sleep(0.5)
                                    print(approch_angle,'5-1',avg_width2,avg_height2,';',width,height)
                            elif 450>width>=430:
                                if cal_angle6 <= 1:
                                    approch_angle5= math.degrees(math.acos(cal_angle6))
                                    #time.sleep(0.5)
                                    print(approch_angle,'6')#,avg_width2,avg_height2,';',width,height)
                                else:
                                    approch_angle5= math.degrees(math.acos(0.99999))
                                    time.sleep(0.5)
                                    print(approch_angle,'6-1',avg_width2,avg_height2,';',width,height)        
                            # draw 3 angle lines
                            ...
                            display(avg_dist_m, approch_angle, True, '_', '_', True, 'velocity')
