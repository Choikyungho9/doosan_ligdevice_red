...
sys.stdout = open('0722_test/210722_dist-angle-','w')
...
def detect(weights='yolov5s.pt',  # model.pt path(s)
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            v = (-45208.0986+(32437438.9675/value)+(-7768478625.25/(value**2))+(621314671064.0006/(value**3)))
            if v >= 0:
                print(v)
            else:
                pass
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if c == 1:
                            ...
                            display(dist_m, angle_text, True, '_', '_', True, v)
            ...
            print(f'({t2 - t1:.3f})')
            print(f'Current FPS: ({FPS})' ,datetime.utcnow().strftime('%M:%S.%f')[:-3], v)
            # Stream results
            if view_img:
