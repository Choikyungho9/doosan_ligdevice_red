                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if c == 1:
                            ...
                            if len(readings_dist_m)==max_dist_m_samples:
                                readings_dist_m = np.delete(readings_dist_m,0)
                                display(avg2, angle_text, True, '_', '_', True,v2) 
                            ...
                            if 50<=avg2<60 :
                                display(avg2-20, angle_text, True, '_', '_', True, v2)
                            elif 60<=avg2<100: 
                                display(avg2-10, angle_text, True, '_', '_', True, v2)
                            elif 100<=avg2<150: 
                                display(avg2-7, angle_text, True, '_', '_', True, v2) 
                            elif 150<=avg2<180: 
                                display(avg2+5, angle_text, True, '_', '_', True, v2)
                            elif 180<=avg2<200: 
                                display(avg2+6.5, angle_text, True, '_', '_', True, v2)
                            elif 200<=avg2<240: 
                                display(avg2+6, angle_text, True, '_', '_', True, v2)                       
                            elif 240<=avg2<265 :
                                display(avg2+5, angle_text, True, '_', '_', True, v2)
                            elif 265<=avg2<280 :
                                display(avg2+11, angle_text, True, '_', '_', True, v2)
                            elif 280<=avg2<310 :
                                display(avg2+21, angle_text, True, '_', '_', True, v2)
                            else:
                                pass
                            # -------------------------------------------------------------------------------------------------
                            print(avg2,'1')
