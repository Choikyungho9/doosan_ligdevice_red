                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if c == 1:  # pallet
                            ...
                            if c == 2:  # pallet_hole
                                # x,y,w,h = cv2.boundingRect(xyxy)
                                # Draw circle in the center of the bounding box
                                hole_x00 = int(x_top)*2  # + int(width / 2)
                                hole_y00 = int(y_top)*2  # + int(height/2)
                                hole_x01 = int(x_top + width)*2
                                hole_y10 = int(y_top + height)*2
                                ...
                                if hole_centerx < pallet_centerx:
                                    ...
                                    cv2.putText(im0, f'{estimated_real_xdistance},{estimated_real_ydistance}',
                                                (ref_w - 550, ref_h - 550),
